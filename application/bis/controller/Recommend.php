...
class Recommend extends Base {
    ...
    public function index(){
        ...
        //获取总数
        $count = model('Recommed')->getAllRecommendsCount($bis_id);
        $pages = ceil($count / $limit);
        $rec_res = model('Recommed')->getAllRecommends($bis_id,$limit,$offset);
        return $this->fetch('',[
            'rec_res'  => $rec_res,
            'pages'  => $pages,
    ...
    public function edit(){
        ...
        $id = input('get.id');
        //获取该商品信息
        $rec_res = model('Recommed')->getRecInfoById($id);
    ...
    public function save(){
        ...
        //普通数据添加到商品表中
        $r_res = model('Recommed')->add($recommend_data);
